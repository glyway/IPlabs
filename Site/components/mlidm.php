<div id="mlidmW" class="aboutWrapper" style="display: none">
    <div class="about">
        ...
        <div class="aboutEl mlidmEl">
            <div class="aboutTextWrapper" style="width: 600px">
                ...
                <div class="aboutText">
                    ...
                    <p class="aboutItem"><span class="bold">Ссылка: </span><a href="https://github.com/glyway/MLDMlabs/tree/master/lab1">https://github.com/glyway/MLDMlabs/tree/master/lab1</a></p>
                </div>
            </div>
        </div>
        <div class="aboutEl mlidmEl">
            <div class="aboutTextWrapper" style="width: 600px">
                ...
                <div class="aboutText">
                    <p class="aboutItem"><span class="bold">Описание: </span>Разработать программу, определяющую свойства отношения. Формат ввода определяется заданием. Необходимо выполнить проверку корректности ввода отношения.
                        Определяемые свойства: рефлексивность, симметричность, кососимметричность, транзитивность</p>

                    <p class="aboutItem"><span class="bold">Ссылка: </span><a href="https://github.com/glyway/MLDMlabs/tree/master/lab2">https://github.com/glyway/MLDMlabs/tree/master/lab2</a></p>
                </div>
            </div>
        </div>
        <div class="aboutEl mlidmEl">
            <div class="aboutTextWrapper" style="width: 600px">
                ...
                <div class="aboutText">
                    ...
                    <p class="aboutItem"><span class="bold">Ссылка: </span><a href="https://github.com/glyway/MLDMlabs/tree/master/lab3">https://github.com/glyway/MLDMlabs/tree/master/lab3</a></p>
                </div>
            </div>
        </div>
        <div class="aboutEl mlidmEl">
            <div class="aboutTextWrapper" style="width: 600px">
                ...
                <div class="aboutText">
                    ...
                    <p class="aboutItem"><span class="bold">Ссылка: </span><a href="https://github.com/glyway/MLDMlabs/tree/master/lab4">https://github.com/glyway/MLDMlabs/tree/master/lab4</a></p>
                </div>
            </div>
        </div>
        <div class="aboutEl mlidmEl">
            <div class="aboutTextWrapper" style="width: 600px">
                ...
                <div class="aboutText">
                    ...
                    <p class="aboutItem"><span class="bold">Ссылка: </span><a href="https://github.com/glyway/MLDMlabs/tree/master/lab5">https://github.com/glyway/MLDMlabs/tree/master/lab5</a></p>
                </div>
            </div>
        </div>
    </div>
